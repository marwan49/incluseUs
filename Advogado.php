...
<head>
    ...
    <title>Página Advogado</title>
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0' name='viewport' />
    <link href="Complementos/css/bootstrap.css" rel="stylesheet" />
    <link href="Complementos/css/stylePADV.css" rel="stylesheet"/>
    ...
    <nav class="navbar navbar-default navbar-transparent navbar-fixed-top" color-on-scroll="200">
        <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a href="Advogado.php" class="navbar-brand">
        ...
        <div class="section section-header" id="PRINCI">
            <div class="parallax filter filter-color-purple">
                <div class="image"
                    style="background-image: url('Fotos2/justica4.jpg">
                </div>
                <div class="container">
                    <div class="content">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="info-icon">
                        ...
                        <p class="description">É importante que você seja claro, objetivo e transparente em seu aconselhamento, lembre-se muita das nossas vítimas possuem baixa escolaridade, portanto é necessário que ela entenda cada ponto do seu aconselhamento.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="info-icon">
                        ...
                        <h3>Trabalhe conscientemente</h3>
                        <p class="description">É necessário que você entenda que nossa plataforma é responsável apenas pela intermediação entre vítima e advogado. O seu trabalho e aconselhamento partem de você, e quem se policia é você, portanto, pedimos encarecidamente que você trabalhe o melhor possível, lembre-se de tratar todo e qualquer caso com cautela, sabedoria e responsabilidade.
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="info-icon">
                        ...
                        <h3>Concordar</h3>
                        <p class="description">Ao assumir o seu primeiro caso, você estará concordando com esses termos e condições, a quebra desses termos podem levar a problemas judiciais, extensos e burocráticos</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="parallax filter filter-color-purple">
            ...
            <div class="container">
                <div class="title-area">
                    ...
                    <div class="row">
                            <div class="button-get-started">
                              <a href="Casos.php" class="btn btn-fill btn-lg btn-warning text-center">Ver casos</a>
                            </div>
            ...
            <div class="content">
                <div class="row">
                    <div class="title-area">
                        ...
                        <p class="description">A Incluse.us é uma plataforma totalmente beneficente e sem fins lucrativos, ela possui propósitos acadêmicos, o seu funcionamento e manutenção é provido por um pequeno número de estudantes programadores. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="depoimento1">
                <p class="description">
                    A minha experiência com a Incluse.US foi algo realmente incrível, a plataforma funciona de maneira muito clara, com ela auxiliei e aconselhei diversas pessoas. <b>Me sinto realizado.</b>
                </p>
            </div>
